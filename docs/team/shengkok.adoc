...
* *Sample code contributed*: [https://github.com/Shengkok/main/blob/master/src/main/java/seedu/address/logic/commands/AddNotesCommand.java[Functional code]] [https://github.com/CS2113-AY1819S2-M11-2/main/tree/master/src/test/java/seedu/address/model/notes[Test code]]
[https://nuscs2113-ay1819s2.github.io/dashboard-beta/#search=Lew%20Sheng%20Kok[Reposense]]
...
A project done by my partner Nicholas Lee and I on the Basys 3 FPGA board. It revolves around sound waves and how they can be displayed on various platforms such as on the monitor screen. Check out the link below to find out more.

https://github.com/Nicholas-Kayden/EE2026[EE2026 FPGA Project]
