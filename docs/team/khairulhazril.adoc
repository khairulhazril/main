...
* *Major enhancement 1*: *Sort* - Sorts the tasks in the task manager by name, module, date or priority.
** What it does:
*** allows the user to view the tasks in a more systematic order
*** a
