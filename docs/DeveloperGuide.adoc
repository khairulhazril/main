...
The Calendar extends `TaskManager`'s GUI with an easy to read interface for tracking task deadlines. It is composed of two classes, `CalendarPanel` and `CalendarCell`.
