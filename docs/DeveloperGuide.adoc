...
1. Section 3.2.2, Signup Command +
2. <<Login Command>> +
3. <<Logout Command>> +
4. <<DeleteAcc Command>>
...
Most of the functions in the `logic` component will be repeated.
This will violate Single Responsibility Principle and Separation of Concerns.

==== Aspect: How the securing of password is implemented

* ** Alternative 1 (current choice): ** Create my own hashing fuction to secure password
...
The code will be mroe complex.

* ** Alternative 2: ** Use encryption library to secure password
...
The password will not be secure.
