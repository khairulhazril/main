...
image::ClassDiagramForNotes.png[width="450"]
...
==== Current assumptions
* Notes added are minor notes that can be completed in a day (E.g Buying eggs from market).
* Student Buddy is turned off at the end of the day when user's personal computer is turned off.
==== Current Implementation
