...
** Cons: May neglect duplicate notes that mean the same as IsSameNotes check for the exact same heading and content. E.g 1. h/popular c/buy ring file 2.h/popular c/buy ring files
