...
public class TaskManagerParserTest {
    ...
    @Test
    public void parseCommand_finddate() throws Exception {
        List<String> keywords = Arrays.asList("03-03", "21-01", "08-05");
        FindDateCommand command = (FindDateCommand) parser.parseCommand(
                FindDateCommand.COMMAND_WORD + " " + keywords.stream().collect(Collectors.joining(" ")));
        assertEquals(new FindDateCommand(new DueContainsKeywordsPredicate(keywords)), command);
    }

    @Test
    public void parseCommand_findname() throws Exception {
        List<String> keywords = Arrays.asList("Project", "Test", "Tutorial");
    ...
    public void parseCommand_findmodule() throws Exception {
        List<String> keywords = Arrays.asList("CS2113T", "CS2101", "CG2028");
    ...
    @Test
    public void parseCommand_findpriority() throws Exception {
        List<String> keywords = Arrays.asList("2", "1", "3");
        FindPriorityCommand command = (FindPriorityCommand) parser.parseCommand(
                FindPriorityCommand.COMMAND_WORD + " " + keywords.stream().collect(Collectors.joining(" ")));
        assertEquals(new FindPriorityCommand(new PriorityContainsKeywordsPredicate(keywords)), command);
    }
    @Test
