...
//        ModelHelper.setFilteredList(expectedModel, LAB); // first names of Benson and Daniel are "Meier"
...
//        command = FindCommand.COMMAND_WORD + " LECTURE";
//        ModelHelper.setFilteredList(expectedModel, LECTURE);
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
...
//        assertFalse(getModel().getTaskManager().getTaskList().contains(LAB));
//        command = FindCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_MEIER;
...
//        command = FindCommand.COMMAND_WORD + " " + LAB.getModule().value;
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
//        /* Case: find address of task in address book -> 0 persons found */
//        command = FindCommand.COMMAND_WORD + " " + LAB.getPriority().value;
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
...
//        List<Tag> tags = new ArrayList<>(LAB.getTags());
