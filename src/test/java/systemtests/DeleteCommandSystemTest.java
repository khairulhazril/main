...
//
//public class DeleteCommandSystemTest extends TaskManagerSystemTest {
//
...
//                getModel().getTaskManager().getTaskList().size() + 1);
...
//     * {@code TaskManagerSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
