    ...
    public static Task[] getSampleTasks() {
        ...
        return new Task[]{
            ...
            new Task(new Name("Finals"), new Module("CG2028"), new Due("20-" + currMonth),
                    new Priority("1"),
                    getTagSet("veryImportant")),
            new Task(new Name("Finals"), new Module("GES1003"), new Due("27-" + currMonth),
                    new Priority("1"),
                    getTagSet("veryImportant")),
            new Task(new Name("Redo Tutorial 2"), new Module("CG2028"), new Due("01-" + currMonth),
                    new Priority("3"),
                    getTagSet("Practice")),
            new Task(new Name("Tutorial 4"), new Module("CG2028"), new Due("04-" + currMonth),
                    new Priority("3"),
                    getTagSet("Practice")),
            ...
            new Task(new Name("Consultation"), new Module("CG2023"), new Due("30-" + currMonth),
                    new Priority("3"),
                    getTagSet("Tutorial3")),
            new Task(new Name("Tutorial 1"), new Module("CG2023"), new Due("02-" + currMonth),
                    new Priority("3"),
                    getTagSet("1hr")),
            new Task(new Name("Tutorial 2"), new Module("CG2023"), new Due("04-" + currMonth),
                    new Priority("3"),
                    getTagSet("1hr")),
            new Task(new Name("Tutorial 3"), new Module("CG2023"), new Due("06-" + currMonth),
                    new Priority("3"),
                    getTagSet("1hr")),
        };
    }
