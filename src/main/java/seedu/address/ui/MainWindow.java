...
public class MainWindow extends UiPart<Stage> {
     ...
     */
    void fillInnerParts() {
        calendarPanel = new CalendarPanel(logic.getFilteredTaskList(), logic.selectedTaskProperty(),
                logic.currentMonthProperty(), logic);
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getTaskManagerFilePath(), logic.getTaskManager());
